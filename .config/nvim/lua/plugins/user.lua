...
return {
    ...
    config = function()
      ...
      neoscroll.setup {
        post_hook = function(info)
          if info ~= "center" then return end
          ...
          vim.defer_fn(function() neoscroll.zz(zz_time_ms, easing) end, defer_time_ms)
        end,
      }
  ...
  },
  {
    ...
    config = function(plugin, opts)
      require "astronvim.plugins.configs.nvim-autopairs"(plugin, opts) -- include the default astronvim config that calls the setup call add more custom autopairs configuration such as custom rules
      ...
      npairs.add_rules(
        {
          Rule("$", "$", { "tex", "latex" })
            ...
            ) -- Select opencode from visual/normal mode
